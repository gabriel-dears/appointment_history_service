...
# Copy appointment_history_service source and build
COPY appointment_history_service/src /app/appointment_history_service/src
RUN mvn -f /app/appointment_history_service/pom.xml clean package -DskipTests
...
COPY --from=build /app/appointment_history_service/target/appointment_history_service-0.0.1-SNAPSHOT.jar app.jar
