...
import com.hospital_app.appointment_history_service.infra.adapter.out.db.jpa.appointment_history.query.AppointmentHistoryQueryFactory;
...
public class CustomJpaAppointmentHistoryRepository implements CustomAppointmentHistoryRepository {
    ...
    public CustomJpaAppointmentHistoryRepository(JpaAppointmentHistoryRepository jpaAppointmentHistoryRepository, JpaAppointmentHistoryMapper jpaAppointmentHistoryMapper, AppointmentHistoryQueryFactory appointmentHistoryQueryFactory) {
    ...
    public ApplicationPage<AppointmentHistory> findByAppointmentId(UUID appointmentId, boolean lastVersionOnly, int page, int size, AppointmentDateTimeScope appointmentDateTimeScope) {
        ...
        Page<JpaAppointmentHistoryEntity> result = appointmentHistoryQueryFactory.getQuery(appointmentDateTimeScope).findByAppointmentId(
